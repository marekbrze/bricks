...
/** Mirrors `PathsDataUnreadable` — corrupt `goals` value, distinct from an empty tree. */
export function GoalsDataUnreadable({ onReset }: { onReset: () => void }) {
  ...
  return (
    <section className="flex flex-col items-center gap-3 py-16 text-center">
      ...
      <div className="max-w-md">
        <h1 className="text-sm font-semibold">We couldn’t read your saved Goals</h1>
      ...
      <AlertDialog open={confirming} onOpenChange={setConfirming}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Reset all Goals data?</AlertDialogTitle>
            <AlertDialogDescription>
