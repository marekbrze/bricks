...
export { MOCK_PATHS, MOCK_ACTIONS, MOCK_GOALS }
...
/** Seed `paths` + `goals` + `actions`, then render the Actions view at `/actions`. */
export function withActionsData(
...
export function seedCorruptActions(initialPath = '/actions'): Decorator {
  return (Story) => {
    __resetStorageHealth()
    try {
