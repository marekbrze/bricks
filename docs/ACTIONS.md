...
| View Path overview | Vision summary (with achievement progress) + per-Path win balance + the inline Goal tree | Owner | Goal tree embedded via `PathGoalsSection`; no separate Goals tab — ADR 0043 |
